...
(function (k) {
    function r(a, b) {
        var c, f, d, g, h, i, n, e, j, o = b && b.split("/"), k = l.map, m = k && k["*"] || {};
        if (a && "." === a.charAt(0))if (b) {
            o = o.slice(0, o.length - 1);
            a = o.concat(a.split("/"));
            for (e = 0; e < a.length; e += 1)if (c = a[e], "." === c)a.splice(e, 1), e -= 1; else if (".." === c)if (1 === e && (".." === a[2] || ".." === a[0]))break; else 0 < e && (a.splice(e - 1, 2), e -= 2);
            a = a.join("/")
        ...
        if ((o || m) && k) {
            ...
            for (e = c.length; 0 < e; e -= 1) {
                f = c.slice(0, e).join("/");
                if (o)for (j = o.length; 0 < j; j -= 1)if (d = k[o.slice(0,
                        j).join("/")])if (d = d[f]) {
                    g = d;
                    h = e;
                    break
    ...
    function w(a, b) {
        return function () {
            return q.apply(k, y.call(arguments, 0).concat([a, b]))
        }
    }
    ...
    function s(a) {
        ...
        if (!j.call(h, a) && !j.call(u, a))throw Error("No " + a);
        return h[a]
    }
    ...
    function B(a) {
        return function () {
            return l && l.config && l.config[a] || {}
        }
    }

    var t, q, v, p, h = {}, m = {}, l = {}, u = {}, j = Object.prototype.hasOwnProperty, y = [].slice;
    v = function (a, b) {
        var c, f = x(a), d = f[0], a = f[1];
        d && (d = r(d, b), c = s(d));
        d ? a = c && c.normalize ? c.normalize(a, z(b)) : r(a, b) : (a = r(a, b), f = x(a), d = f[0], a = f[1], d && (c = s(d)));
    ...
    p = {
        ...
        module: function (a) {
            return {id: a, uri: "", exports: h[a], config: B(a)}
        }
    };
    t = function (a, b, c, f) {
        var d, g, l, i, n = [], e, f = f || a;
        if ("function" === typeof c) {
            b = !b.length && c.length ? ["require", "exports", "module"] : b;
            for (i = 0; i < b.length; i += 1)if (l = v(b[i], f), g = l.f, "require" === g)n[i] = p.require(a); else if ("exports" === g)n[i] = p.exports(a), e = !0; else if ("module" === g)d = n[i] = p.module(a); else if (j.call(h, g) || j.call(m, g) || j.call(u, g))n[i] = s(g); else if (l.p)l.p.load(l.n, w(f, !0), A(g), {}), n[i] = h[g]; else throw Error(a + " missing " + g);
            b = c.apply(h[a],
                n);
            if (a)if (d && d.exports !== k && d.exports !== h[a])h[a] = d.exports; else if (b !== k || !e)h[a] = b
        } else a && (h[a] = c)
    };
    requirejs = require = q = function (a, b, c, f, d) {
        if ("string" === typeof a)return p[a] ? p[a](b) : s(v(a, b).f);
        a.splice || (l = a, b.splice ? (a = b, b = c, c = null) : a = k);
        b = b || function () {
            };
        "function" === typeof c && (c = f, f = d);
        f ? t(k, a, b, c) : setTimeout(function () {
            t(k, a, b, c)
        }, 4);
        return q
    };
    ...
    define = function (a, b, c) {
        b.splice || (c = b, b = []);
        !j.call(h, a) && !j.call(m, a) && (m[a] = [a, b, c])
    };
    define.amd = {jQuery: !0}
})();
...
(function (d) {
    var e = window.require, c = function (a, b, c, d, f) {
        return e.call(this, a, b, c, !0, f)
    };
    d.require = function () {
...
var as24 = as24 || {};
as24.ui = as24.ui || {};
as24.ui.parseWidgetOptions = function (b) {
    var a;
    try {
        a = (new Function("return {" + b + "}"))()
    } catch (c) {
        throw Error("invalid widget options");
    }
    return a
};
as24 = as24 || {};
as24.ui = as24.ui || {};
(function (b) {
    as24.ui.setCookie = function (a, b, d) {
        null === b && (b = "", d = -1);
        if (d) {
            if ("number" == typeof d) {
                var e = new Date;
...
(function (b) {
    b(document).ready(function () {
        b(document).initializeWidgets()
    });
    var a = "bubble,boxSticky,expandable,customDropdown,pictureGallery,characterCounter,customDropdownNew".split(","), c = ["tabs", "datepicker", "slider"];
    b.fn.initializeWidgets = function () {
        var e, i, h, j;
        if (0 == arguments.length)return b(this).initializeWidgets.apply(this, a), b(this).initializeWidgets.apply(this, c), this;
        for (e = 0; e < arguments.length; e++) {
            i = arguments[e];
            j = -1 < b.inArray(i, a) ? "as24" : -1 < b.inArray(i, c) ? "ui" : "";
            h = f(i);
            h = "data-ui-" +
                h;
            var k = b(this).find("[" + h + "]");
            d(b(this), h) && (k = k.add(b(this)));
            k.each(function () {
                if (0 === b(this).parents("pre").length) {
                    var a = b(this), c = j, d = i;
                    if (!("datepicker" == d ? null != b(a).data("datepicker") : b(a).is(":" + c + "-" + d)))a = as24.ui.parseWidgetOptions(b(this).attr("data-ui-" + i) || ""), b(this)[i](a)
                }
            })
        }
        return this
    ...
    var d = function (a, c) {
        return null != b(a).attr(c)
    }, e = RegExp(/([A-Z])/g), f = function (a) {
...
(function () {
    ...
    as24.ui.PubSub = {
        subscribe: function (a, c) {
            ...
            var a = Array.prototype.slice.apply(arguments), c = a.shift();
            if (b[c]) {
                var d, e;
                for (d = 0, e = b[c].length; d < e; d++)b[c][d].apply({}, a)
            }
        }, Events: {dropdownSelectionApplied: "dropdownSelectionApplied"}
    }
})();
$.fn.placeholder = function () {
    return "placeholder"in document.createElement("input") ? this : this.each(function () {
        var b = function (a, b) {
            "" == a.val() && a.css("color", "#888888").val(b)
        };
        $(this).find("[placeholder]:not([placeholder-activated])").each(function () {
            var a = $(this), c = a.attr("placeholder"), d = a.css("color");
            a.closest("form").submit(function () {
                a.val() == c && a.val("")
            });
            a.bind("focus keydown", function () {
                a.val() == c && a.css("color", d).val("")
            });
            a.blur(function () {
                b(a, c)
            });
            b(a, c);
            a.attr("placeholder-activated",
                !0)
        })
    })
};
...
(function (b) {
    ...
    b.fn.initBoxLight = function () {
        b("[data-boxLight-autoOpen=true]").each(function () {
            b(window).boxLight({content: this}).blockIt()
        });
        b("[data-boxLight-openerElement]").each(function () {
            var a = b(this), c = b(this).attr("data-boxLight-openerElement");
            b("#" + c).on("click", a, function (c) {
                b(window).boxLight({content: a}).blockIt();
                c.preventDefault()
            })
        })
    };
    b.fn.closeBoxLight = function () {
        var a = b("body");
        b.unblockUI();
        setTimeout(function () {
                b(a).removeClass("boxLightOpen")
            },
            350)
    };
    b.fn.boxLight = function (a) {
        var c = this, d, e = b("body"), f, g, i = b('<div class="boxLight" style="position: absolute; display: none;" />'), h = b("<div />").appendTo(i);
        "undefined" === typeof a.boxCssClass ? h.addClass("boxLightContent") : h.addClass(a.boxCssClass);
        if ("undefined" === typeof a.responsive)"undefined" === typeof a.boxWidthCssClass ? h.addClass("gridWidth4") : h.addClass(a.boxWidthCssClass); else if (993 <= b(window).width()) {
            var j = "undefined" === typeof a.boxWidthCssClass ? 4 : a.boxWidthCssClass.replace("gridWidth",
                "");
            h.css("width", b(window).width() * (j / 12) + "px")
        } else h.css("width", 0.9 * b(window).width() + "px");
        if ("undefined" === typeof a.closeButtonVisible)a.closeButtonVisible = !0;
        !1 !== a.closeButtonVisible && "true" !== b(a.content).attr("data-boxLight-noCloseButton") && (f = b('<div class="boxLightCloseButton" data-boxLight-close onclick="" />'), i.append(f));
        this.updateContent = function (a) {
            a = b(a);
            h.empty();
            a.appendTo(h).css({display: "block", visibility: "visible"});
            return c
        };
        a.content && c.updateContent(a.content);
        this.getContent =
            function () {
                return h
            };
        this.blockIt = function (a, f) {
            var g = !0, h = !0;
            a && (a.bindEvents || (g = !1), a.focusInput || (h = !1));
            var j = c._calculatePosition();
            d = new Date;
            b.blockUI({
                focusInput: h,
                message: i,
                ...
                onBlock: function () {
                    "function" === typeof f && f();
                    if (a && "function" === typeof a.onBlock)a.onBlock()
                }
            });
            b(".blockMsg").css("width", "auto").appendTo(".blockOverlay");
            (0 <= navigator.userAgent.indexOf("MSIE 7") || 0 <= navigator.userAgent.indexOf("MSIE 8")) && b(".blockOverlay").css({
                filter: "progid:DXImageTransform.Microsoft.gradient(startColorstr=#BBFCFCFC, endColorstr=#BBFCFCFC)",
                "background-color": "transparent"
            });
            e.addClass("boxLightOpen");
            return c
        };
        this.unblockIt = function (f) {
            if ("function" === typeof a.onbeforeclose)a.onbeforeclose();
            b(document).trigger("boxLightBeforeClose");
            g && g.unblockIt(function () {
                g.remove();
                g = null
            });
            var l = +new Date - d;
            if (750 > l)return setTimeout(function () {
                c.unblockIt(f)
            }, 750 - l), c;
            b.unblockUI({
                onUnblock: function () {
                    e.removeClass("boxLightOpen");
                    if ("function" === typeof f)f(); else if ("function" === typeof a.onclose)a.onclose()
                }
            });
            b(document).trigger("boxLightClose");
            return c
        };
        this._calculatePosition = function () {
            var a, c;
            i.is(":visible") ? a = i.width() : (c = i.clone(!1, !1).css({
                display: "block",
                position: "absolute",
                left: -9999
            }), c.find("object").remove(), c.appendTo("body"),
                a = c.find(".boxLightContent").outerWidth(!0), c.remove());
            c = b(".grid");
            return {
                top: "15%",
                left: 0 < c.length ? (c.width() - a) / 2 + c.offset().left : (b(window).width() - a) / 2
            }
        };
        this.reposition = function () {
            var a = c._calculatePosition();
            i.parent().css({left: a.left, top: a.top});
            b(".blockUI").scrollTop(0);
            return c
        };
        this.setBusy = function (a) {
            g = g || b("<div />").css({
                    ...
                    width: h.width(),
                    height: h.height(),
                    top: (h.outerHeight(!0) - h.height()) / 2,
                    left: (h.outerWidth(!0) - h.width()) / 2
                }).appendTo(i).blockElement();
            g.blockBusy(a);
            f && f.hide();
            return c
        };
        this.setNotBusy = function (a) {
            g && g.unblockIt(function () {
                f && f.show();
                g.detach();
                g = null;
        ...
        b(c.getContent()).parent().on("click", "[data-boxLight-close]", {}, function () {
            c.unblockIt();
            return !1
        });
        return c
    };
    b.fn.blockElement = function () {
        var a = this, c;
        this.blockIt = function (d) {
            d = d || {};
            c = new Date;
            var e = b.extend(b.blockUI.defaults.css, {
                border: "none",
                width: "100%",
                "background-color": "transparent",
                opacity: 0.8
            });
            null !== d.css && b.extend(e, d.css);
            var f = {
                opacity: 0.8,
                backgroundColor: "#FFF"
            };
            null !== d.overlayCss && b.extend(f, d.overlayCss);
            a.block({
                message: d.content,
                css: e,
                overlayCSS: f,
                baseZ: "undefined" !== typeof f.zIndex ? f.zIndex : b.blockUI.defaults.baseZ,
                centerY: "undefined" !== typeof d.centerY ? d.centerY : b.blockUI.defaults.centerY
            });
            "function" === typeof d.onBlocked && setTimeout(d.onBlocked, 250);
            return a
        };
        this.unblockIt = function (b) {
            var e = new Date - c;
            if (720 > e)return window.setTimeout(function () {
                a.unblockIt(b)
            }, 720 - e), a;
            a.unblock({onUnblock: b});
            return a
        };
        this.blockBusy = function (b) {
            b =
                b || {};
            b.busyMessage = b.busyMessage || "Bitte warten";
            b.content = b.content || '<div class="preloader"><div class="preloaderIcon"></div><p class="preloaderText paddingTopFontS">' + b.busyMessage + "</p></div>";
            a.blockIt(b);
            return a
        };
        return this
...
(function (b) {
    b.fn.boxLightNew = function (a) {
        return this.each(function () {
            var c = b(this).clone(), d = b('<div class="boxLightOverlay"/>');
            c.trigger("boxLightNewBeforeOpen");
            b("body").append(d.append(c.hide())).addClass("boxLightOpen");
            (function () {
                var d, f;
                993 <= b(window).width() ? (f = 993 * (("undefined" === typeof a.columns ? 4 : a.columns) / 12), d = (993 - f) / 2) : (f = "90%", d = "5%");
                c.css({top: "15%", position: "absolute", left: d, width: f, zIndex: 100001})
            })();
            c.show(300);
            c.trigger("boxLightNewOpened");
            c.on("click.boxLightNew", "[data-boxLightNew-close]",
                function (a) {
                    c.trigger("boxLightNewBeforeClose");
                    b("body").removeClass("boxLightOpen");
                    d.remove();
                    c.trigger("boxLightNewClosed");
                    a.preventDefault()
                })
        })
    };
    b(document).on("click", "#testBoxOpener", function () {
        b("#boxlightNew").boxLightNew({columns: 5})
    })
})(jQuery);
(function (b) {
    b.widget("as24.boxSticky", {
        options: {top: 0, boundary: ".boxStickyBoundary", cssClass: ""}, destroy: function () {
            this._removeActivatedSticky();
            b(window).off("scroll." + this.id)
        }, _removeActivatedSticky: function () {
            if ("undefined" !== typeof this.placeholder)this.placeholder.remove(), this.placeholder = void 0, this.box.css(this.boxCss).removeClass(this.options.cssClass)
        }, create: function () {
            this._create()
        }, _create: function () {
            var a = this;
            a.box = this.element;
            a.boxPosition = a.box.position();
            a.placeholder = void 0;
            a.boxCss = {
                position: a.box.css("position"),
                top: a.boxPosition.top,
                width: a.box.width(),
                marginTop: a.box.css("marginTop"),
                left: a.boxPosition.left
            };
            var c = a.box.outerHeight(!1) + a.options.top, d = {
                height: c,
                width: a.boxCss.width,
                left: a.boxCss.left,
                top: a.boxCss.top,
                visibility: "hidden"
            }, e = {
            ...
            a.id = a.element[0].id ? a.element[0].id : "stickyid" + Math.floor(200 * Math.random());
            b(window).on("scroll." + a.id, function () {
                c = a.box.outerHeight(!1) +
                    a.options.top;
                var g = b(a.options.boundary), i = g.outerHeight(!1), g = g.offset() ? g.offset().top : 0, i = i + g, h = b(window).scrollTop(), j = b(window).height();
                if (990 > b(window).width() || h < g && void 0 != a.placeholder || j < c - a.boxCss.marginTop)a._removeActivatedSticky(); else if (h > g && h < i - c) {
                    if ("undefined" === typeof a.placeholder)a.placeholder = b("<div/>").css(d).addClass(f), a.box.before(a.placeholder), a.box.css(e).addClass(a.options.cssClass);
                    a.box.css("top", a.options.top)
                } else h > i - c && a.box.css("top", i - c - h + a.options.top)
            })
        }
    })
})(jQuery);
(function (b) {
    b.fn.refreshBubbles = function () {
        b(":as24-bubble").each(function () {
            b(this).bubble("isOpen") && b(this).bubble("refresh")
        });
        return !1
    };
    b.fn.closeBubbles = function () {
        b(":as24-bubble").each(function () {
            b(this).bubble("isOpen") && b(this).bubble("close")
        });
        return !1
    };
    b.widget("as24.bubble", {
        options: {
            bubbleClass: "",
            closeOnEscape: null,
            cookieName: null,
            cookieExpires: 3650,
            contentClass: "gridWidth4",
            id: "bubble",
            lockPosition: !1,
            positionRelative: !1,
            pointer: "leftTop",
            positionOptions: {
                marginLeft: 32, marginTop: 18,
                pointerWidth: 10, pointerHeight: 12, spacingFromTargetToPointer: 9
            },
            pointerCalculatedMargin: {left: 32, top: 18},
            target: null,
            targetClass: null,
            trigger: null,
            type: "info",
            ...
            var a = this, c = "bubble" === a.options.id ? a.options.id + Math.floor(200 * Math.random()) : a.options.id, d = a.options;
            a.id = c;
            a.mouseOverTimer = null;
            a.uiBubble = b("<div></div>").addClass("bubble " + d.bubbleClass).attr("id", c).css({
                position: "absolute",
                zIndex: d.zIndex
            });
            a.parentElement = a.element.parent();
            a.uiBubbleContent = b("<div></div>").addClass("bubbleContent " +
                d.contentClass + " clearfix").append(a.element.show()).appendTo(a.uiBubble);
            a.uiBubblePointer = b("<div></div>");
            a.uiBubbleClose = b("<div></div>").addClass("bubbleClose").click(function () {
                a._closeEvents("closeoncloseicon");
                return !1
            });
            "" === d.contentClass && a.uiBubbleContent.css("width", a.element.outerWidth + "px");
            if (a.options.target)a.options.target = b(a.options.target);
            if (a.options.trigger)a.options.trigger = b(a.options.trigger);
            a._registerEscapeEvent();
            a._renderTypeSpecificUI();
            a._registerInnerCloseEvent();
            a.uiBubble.hide();
            a._isOpen = !1
        }, _hasMultipleTargets: function () {
            return 1 < b(this.options.target).length
        }, _init: function () {
            "note" === this.getType() && this.open(this.options.target)
        }, destroy: function () {
            b.Widget.prototype.destroy.apply(this, arguments);
            this.uiBubble.remove()
        }, widget: function () {
            return this.uiBubble
        }, close: function () {
            this.uiBubble.hide();
            this._isOpen = !1;
            return self
            ...
            var b = this.options,
                d = this.uiBubble, e = this.uiBubblePointer;
            this.currentTarget = a;
            if (this._isOpen && !this._hasMultipleTargets() || !1 === this._trigger("beforeopen", null, this))return this;
            this._closeOpenBubblesInfoOrDecision();
            d.css("visibility", "hidden").show();
            e.attr("class", "bubblePointer" + b.pointer.charAt(0).toUpperCase() + b.pointer.slice(1));
            this._renderPointer();
            this._position(a);
            this._repositionBubbleInfoWhenNotInScreen(a);
        ...
        closeFromOutside: function () {
            this._registerOutsideCloseEvent()
        }, _closeOpenBubblesInfoOrDecision: function () {
            var a = this;
            ("info" === a.getType() || "decision" === a.getType()) && b(":as24-bubble").not(a.element).each(function () {
                var c = b(this);
                c.bubble("isOpen") && c.bubble("getType") === a.getType() && c.bubble("close")
            })
        }, _setOption: function (a, c) {
            var d = this.uiBubble, e = this.uiBubbleContent;
            switch (a) {
                case "bubbleClass":
                    d.removeClass(this.options.bubbleClass).addClass(c);
                    this.refresh();
                    break;
                case "closeOnEscape":
                    this._registerEscapeEvent();
                    this.refresh();
                    break;
                case "contentClass":
                    e.removeClass(this.options.contentClass).addClass(c);
                    this.refresh();
                    break;
                case "pointer":
                    this._resetPointer(this.options.target, c);
                    break;
                case "target":
                    this.options.target = b(c);
                    this._registerOpenerEvents();
                    break;
                case "zIndex":
                    d.css("zIndex", c)
            }
            "target" !== a && b.Widget.prototype._setOption.apply(this, arguments)
        }, _addBubbleToDOM: function () {
            this.uiBubbleClose.prependTo(this.uiBubbleContent);
            this.uiBubble.appendTo("body")
        }, _closeEvents: function (a) {
            this._trigger(a,
                b.Event(a), this);
            this.close();
            this._trigger("close", b.Event(a), this)
        }, _createTargetIfNotExisting: function () {
            if (!this.options.target) {
                var a = this._getTargetClass();
                this.options.target = b("<span></span>").css("display", "inline-block").addClass(a).appendTo(this.parentElement)
            }
        }, _repositionBubbleInfoWhenNotInScreen: function (a) {
            var c = this.options, d = this.uiBubble;
            if ("info" === this.getType() && !c.lockPosition) {
                var e = b(window).scrollTop(), f = e + b(window).height(), g = b(window).scrollLeft(), i = d.offset().top, h = i + d.outerHeight(!1),
                    d = d.offset().left, c = c.pointer;
                0 === c.search(/bottom/) && e > i && (c = c.replace("bottom", "top"));
                0 === c.search(/top/) && f < h && (c = c.replace("top", "bottom"));
                1 < c.search(/Right/) && g > d && (c = c.replace("Right", "Left"));
                this._resetPointer(a, c)
            }
        }, _getPointer: function (a) {
            return !a ? this.options.pointer.toLowerCase() : a.toLowerCase()
        }, _getTargetClass: function () {
            return !this.options.targetClass ? "iconInfoS" : this.options.targetClass
        }, _position: function (a, c) {
            var d = this.options, e = d.positionOptions, f = d.pointerCalculatedMargin, g =
                this.uiBubble, i = this.uiBubbleContent, a = this._hasMultipleTargets() ? a || d.target : d.target || a;
            if ((a = b(a)) && 0 < a.length) {
                var h = a.outerWidth(!1), j = a.outerHeight(!1), k = d.positionRelative ? a.position().top : a.offset().top, l = d.positionRelative ? a.position().left : a.offset().left, o = i.outerWidth(!1), p = i.outerHeight(!1), m = 0, n = 0;
                0 === this._getPointer(c).search(/bottom/) && (m = l + h / 2 - (f.left + e.pointerWidth), n = k - (p + e.pointerHeight + e.spacingFromTargetToPointer));
                0 === this._getPointer(c).search(/top/) && (m = l + h / 2 - f.left, n = k +
                    j + e.spacingFromTargetToPointer);
                0 === this._getPointer(c).search(/right/) && (n = k + j / 2 - (f.top + e.pointerHeight), m = l - (o + e.pointerWidth + e.spacingFromTargetToPointer));
                0 === this._getPointer(c).search(/left/) && (n = k + j / 2 - (f.top + e.pointerHeight), m = l + h + e.spacingFromTargetToPointer);
                g.css({left: Math.ceil(m) + "px", top: Math.ceil(n) + "px"});
                "info" === this.getType() && !d.positionRelative && g.css("position", "absolute")
            } else g.css("position", "");
            g.css("width", i.outerWidth(!1) + e.pointerWidth + "px")
        }, _registerEscapeEvent: function () {
            var a =
                this, c = a.options;
            b(document).off("keydown." + a.id, a).on("keydown." + a.id, a, function (d) {
                if (a.id === d.handleObj.namespace && a.isOpen())c.closeOnEscape = !c.closeOnEscape && "info" === a.getType() ? !0 : c.closeOnEscape, c.closeOnEscape && !d.isDefaultPrevented() && d.keyCode && d.keyCode === b.ui.keyCode.ESCAPE && a._closeEvents("closeonescape")
            })
        }, _registerInnerCloseEvent: function () {
            var a = this;
            a.uiBubble.on("click", "[data-ui-bubble-close]", a, function () {
                a._closeEvents("innerclose")
            })
        }, _registerOpenerEvents: function () {
            if (!("note" ===
                this.getType() || !this.options.target && !this.options.trigger)) {
                var a = b().add(this.options.target).add(this.options.trigger);
                this._registerOpenerClickEvents(a);
                this._registerOpenerMouseOverEvents(a)
            }
        }, _registerOpenerClickEvents: function (a) {
            var b = this;
            a.css("cursor", "pointer").attr("data-ui-bubble-trigger", "1").off("click dblclick").on("click dblclick", function (a) {
                b.open(a.target);
                return !1
            })
        }, _registerOpenerMouseOverEvents: function (a) {
            var c = this;
            if ("info" === this.getType())a.on("mouseover", function (a) {
                c._setMouseOverTimer(a,
                    this)
            }).on("mouseout", function () {
                b(this).removeClass("hasFocus")
            })
        }, _registerOutsideCloseEvent: function () {
            var a = this;
            b(document).off("click." + a.id, a).on("click." + a.id, a, function (c) {
                a.id === c.handleObj.namespace && a.isOpen() && !b(c.target).data("uiBubbleTrigger") && 0 === b(c.target).parents(".bubble").length && a._closeEvents("outsideclose")
            })
        }, _renderPointer: function (a) {
            var b = this.options, d = b.positionOptions, b = b.pointerCalculatedMargin, e = this.uiBubble, f = this.uiBubbleContent, g = this.uiBubblePointer;
            0 === this._getPointer(a).search(/bottom/) ?
                g.appendTo(e) : g.prependTo(e);
            if (0 === this._getPointer(a).search(/left/))d.pointerWidth = 12, d.pointerHeight = 10;
            if (0 === this._getPointer(a).search(/bottom|top/))b.left = 1 < this._getPointer(a).search(/middle/) ? f.outerWidth(!1) / 2 - d.pointerWidth / 2 : 1 < this._getPointer(a).search(/right/) ? f.outerWidth(!1) - (d.marginLeft + d.pointerWidth) : d.marginLeft, g.css("margin-left", b.left);
            if (0 === this._getPointer(a).search(/left|right/))b.top = 1 < this._getPointer(a).search(/middle/) ? f.outerHeight(!1) / 2 - d.pointerHeight / 2 : 1 < this._getPointer(a).search(/bottom/) ?
            f.outerHeight(!1) - (d.marginTop + d.pointerHeight) : d.marginTop, g.css("margin-top", b.top);
            0 === this._getPointer(a).search(/left/) && (g.css("float", "left"), f.css("float", "left"));
            0 === this._getPointer(a).search(/right/) && (g.css("float", "right"), f.css("float", "right"))
        }, _renderTypeSpecificUI: function () {
            var a = this.options, b = this.uiBubble, d = this.parentElement;
            switch (this.getType()) {
                case "decision":
                    this._registerOpenerEvents();
                    b.appendTo("body");
                ...
                case "info":
                    this._registerOutsideCloseEvent();
                    this._createTargetIfNotExisting();
                    this._registerOpenerEvents();
                    this._addBubbleToDOM();
                    break;
                case "note":
                    a.positionRelative ? (b.appendTo(d), d.css("position", "relative"), this.uiBubbleClose.prependTo(this.uiBubbleContent)) : this._addBubbleToDOM();
                    this._setupCookieBehavior();
                    break;
                default:
                    this._addBubbleToDOM()
            }
        }, _resetPointer: function (a, b) {
            this.uiBubblePointer.removeClass("bubblePointer" + this.options.pointer.charAt(0).toUpperCase() + this.options.pointer.slice(1)).addClass("bubblePointer" + b.charAt(0).toUpperCase() + b.slice(1));
            this._renderPointer(b);
            this._position(a, b)
        }, _setMouseOverTimer: function (a) {
            var c = this;
            b(a.target).addClass("hasFocus");
            if (c.mouseOverTimer)clearTimeout(c.mouseOverTimer), c.mouseOverTimer = null;
            c.mouseOverTimer = setTimeout(function () {
                b(a.target).hasClass("hasFocus") && c.open(a.target)
            }, 500)
        }, _setupCookieBehavior: function () {
            var a = this;
            a.options.cookieName && (a.uiBubble.bind("bubblebeforeopen", function () {
                return null == as24.ui.getCookie(a.options.cookieName)
            }), a.uiBubble.bind("bubbleclose", function () {
                as24.ui.setCookie(a.options.cookieName,
                    1, a.options.cookieExpires)
            }))
        }
    })
})(jQuery);
(function (b) {
    b.widget("as24.customDropdown", {
        options: {buttonText: ""}, _updateText: function () {
            0 < this.options.buttonText.length && this.button.html(this.options.buttonText)
        }, _close: function () {
            this.itemList.hide();
            this.element.removeClass("expanded")
        }, _create: function () {
            var a = this;
            a.itemList = a.element.next(".customDropdownKateItemList, .customDropdownBobItemList, .customDropdownWillItemList");
            a.button = a.element.find("button");
            a.element.click(function () {
                a.element.hasClass("disabled") || (a.itemList.toggle(),
                    a.element.toggleClass("expanded"))
            });
            b(document).click(function (c) {
                for (c = b(c.target); 0 < c.length;) {
                    if (c[0] === a.element[0] || c[0] === a.itemList[0])return;
                    c = c.parent()
                }
                a._close()
            });
            ...
            if ("buttonText" === a)this.options.buttonText = c, this._updateText();
            b.Widget.prototype._setOption.apply(this, arguments)
        }, _registerInnerCloseEvent: function () {
            var a = this;
            a.element.on("click", "[data-ui-customDropdown-close]", a, function (b) {
                a._innerClose(b)
            });
            a.itemList.on("click",
                "[data-ui-customDropdown-close]", a, function (b) {
                    a._innerClose(b)
                })
        }, _innerClose: function (a) {
            this._close();
            a.preventDefault()
        }
    })
...
(function (b) {
    b.widget("as24.customDropdownNew", {
        _bindEvents: function (a) {
            var c = a.data("ui-custom-dropdown-new"), d = b("#" + c);
            a.off("click");
            a.on("click", function () {
                d.toggle()
            });
            ...
            this._registerCheckboxEvents(d);
            this._registerApplyButtonEvents(a, d)
        }, _registerCheckboxEvents: function (a) {
            var b = a.find('input[name="group"]'), d = a.find("ul[data-dropdown-checkbox-group]").find('input[type="checkbox"]');
            b.off("click");
            b.on("click", function () {
                d.prop("checked",
                    b.prop("checked"))
            })
        }, _registerApplyButtonEvents: function (a, c) {
            var d = c.find("[data-dropdown-button-apply]"), e = a.find("span"), f = e.text();
            d.off("click");
            d.on("click", function () {
                var d = [];
                c.find('input[type="checkbox"]:checked:not([name="group"])').each(function () {
                    d.push(b(this).val())
                });
                var i = 0 < d.length ? d.join(", ") : f;
                e.css("display", "inline-block");
                e.css("width", a.width() - 15 + "px");
                e.text(i);
                as24.ui.PubSub.publish(as24.ui.PubSub.Events.dropdownSelectionApplied, d);
                c.hide()
            })
        }, _create: function () {
            var a =
                this;
            b(document).find("[data-ui-custom-dropdown-new]").each(function () {
                a._bindEvents(b(this))
            })
        }
    })
})(jQuery);
(function (b) {
    b.widget("as24.expandable", b.ui.accordion, {
        options: {
            active: !1,
            animate: !1,
            collapsible: !0,
            header: "[data-ui-expandable-header]",
            icons: {header: "buttonExpand floatLeft", activeHeader: "buttonExpanded floatLeft"},
            heightStyle: "content"
        }, _create: function () {
            b.ui.accordion.prototype._create.apply(this, arguments);
            var a = this.element.find(this.options.header);
            a.addClass("expandableSection fontIconLink iconSprite").css("outline", 0);
            null !== a.data() && "undefined" !== typeof a.data().uiExpandableHeader && ("buttonAlignRight" ===
            a.data().uiExpandableHeader ? a.addClass("textAndIconM") : a.addClass("iconAndTextM"));
            this._setActiveElement();
            this._registerToggleTextEvent()
        }, _setActiveElement: function () {
            this._activeElement = this.element.find(".ui-state-active")
        }, _registerToggleTextEvent: function () {
            var a = this;
            a.element.on("click", "[data-ui-expandable-header]", a, function () {
                a._switchToCollapsedHeaderText();
                a._setActiveElement();
                a._saveCollapsedHeaderText();
                a._switchToExpandedHeaderText()
            })
        }, _switchToCollapsedHeaderText: function () {
            var a =
                this._getExpandedHeaderText();
            if (a) {
                var b = this._getCollapsedHeaderText();
                this._activeElement.html(this._activeElement.html().replace(a, b))
            }
        }, _saveCollapsedHeaderText: function () {
            this._activeElement.attr("data-ui-expandable-collapsed-text", this._activeElement.text())
        }, _switchToExpandedHeaderText: function () {
            var a = this._getExpandedHeaderText();
            if (a) {
                var b = this._getCollapsedHeaderText();
                this._activeElement.html(this._activeElement.html().replace(b, a))
            }
        }, _getExpandedHeaderText: function () {
            return this._activeElement.attr("data-ui-expandable-expanded-text") ||
                ""
        }, _getCollapsedHeaderText: function () {
            return this._activeElement.attr("data-ui-expandable-collapsed-text") || ""
        }
    })
})(jQuery);
(function () {
    $.as24 = $.as24 || {};
    var b = $.as24.menu = $.as24.menu || {};
    b.settings = b.settings || {};
    b.settings.url = b.settings.url || "";
    b.settings.logoutText = b.settings.logoutText || "LogOut";
    b.settings.logoutUrl = b.settings.logoutUrl || "https://secure.autoscout24.de/Logout.aspx";
    b.settings.highlightElementId = b.settings.highlightElementId || "";
    b.settings.doReloadMenu = null != b.settings.doReloadMenu ? b.settings.doReloadMenu : !0;
    b.settings.dealerWelcomeText = b.settings.dealerWelcomeText || "";
    b.settings.isTouch = "ontouchstart"in
        window || window.DocumentTouch && document instanceof DocumentTouch;
    b.callbacks = b.callbacks || {};
    b.callbacks.submenuOpened = b.callbacks.submenuOpened || [];
    b.init = function () {
        0 < $("#topNavigation").length && (b.settings.doReloadMenu ? b.requestMenu() : b.buildMenu())
    };
    b.requestMenu = function () {
        var a;
        a = -1 < location.hostname.toLowerCase().indexOf("www");
        $.ajax({
            url: a ? b.settings.url.replace("html", "html.aspx") : b.settings.url,
            type: "GET",
            dataType: "html",
            cache: !0,
            success: b.menuLoaded,
            error: b.menuLoadError
        })
    };
    b.menuLoaded =
        function (a) {
            0 < a.length && 0 > a.indexOf("<html") && ($("#topNavigation").replaceWith(a), $.as24.menu.buildMenu())
        };
    b.menuLoadError = function () {
        window.console && console.log("menu load error")
    };
    b.buildMenu = function () {
        $(".navMenuItem").as24menu();
        0 == $(".dynamicDealerMenu").length && $("#loginLink").as24login();
        b.highlightElement(d());
        c();
        a()
    };
    var a = function () {
        $.as24.menu.settings.isTouch && $(".navSubMenu a").click(function (a) {
            a.stopPropagation()
        })
    }, c = function () {
        window.s && "function" == typeof s.tl && "function" == typeof window.$ &&
        "function" == typeof $().delegate && ("undefined" != typeof $.as24.menu.settings.isDealer && $.as24.menu.settings.isDealer ? $(".pageHeader").delegate("[data-omniture], #logOut", "click", function () {
            var a = "logOut" == $(this).attr("id") ? "B2B-Memberarea-Login" : $(this).data("omniture");
            s.linkTrackVars = "prop57";
            s.prop57 = "1" + s.pageName + "|2" + a + "|NaviB2B";
            s.tl(this, "o", "NaviB2B-" + a);
            s.linkTrackVars = "";
            s.prop57 = ""
        }) : $(".pageHeader").delegate("[data-omniture]", "click", function () {
            s.linkTrackVars = "None";
            s.linkTrackEvents =
                "None";
            s.events = "None";
            s.tl(this, "o", $(this).data("omniture"))
        }))
    };
    b.isHighlightElement = function (a) {
        return a.attr("id") === $.as24.menu.settings.highlightElementId
    };
    b.highlightElement = function (a) {
        a.addClass("activeNavMenuItem");
        a.find(".navLink").addClass("highlightLink")
    };
    b.unhighlightElement = function (a) {
        a.removeClass("activeNavMenuItem");
        a.find(".navLink").removeClass("highlightLink")
    };
    var d = function () {
        var a = $.as24.menu.settings.highlightElementId;
        return void 0 === a || "" === a ? $() : $("#" + a)
    };
    b.replaceLoginWithLogout =
        function (a) {
            a.text($.as24.menu.settings.logoutText);
            var b = $(a).attr("href").replace("Login.aspx", "Logout.aspx");
            a.attr("href", b)
        };
    b.hideDealerSubMenu = function () {
        var a = $("#dealer");
        a.next().remove();
        a.remove()
    };
    b.insertLogoutSubmenu = function () {
        var a = $(".navMenuItem.floatLeft").first(), b;
        b = '<div id="logOut" class="navMenuItem floatRight"><a class="navLink" href="' + $.as24.menu.settings.logoutUrl;
        b = b + '">' + $.as24.menu.settings.logoutText + '</a></div><div class="navSeparator floatRight"> </div>';
        b = $(b);
        $(b).insertBefore(a)
    }
})();
(function (b) {
    b.fn.as24menu = function () {
        this.each(function () {
            function a() {
                j.click(function () {
                    var a = b(this), c = !a.hasClass("highlightWithSubmenu");
                    b(".navMenuItem").each(function () {
                        f(this)
                    });
                    k.mouseOverSubMenu = c;
                    k.update();
                    a = a.attr("id");
                    return "logOut" === a || "home" === a || "b2b-home" === a ? !0 : !1
                })
            }
            ...
            function c() {
                ...
                g(j).mouseenter(function () {
                    k.mouseOverSubMenu = !0;
                    k.update()
                });
                g(j).mouseleave(function () {
                    k.mouseOverSubMenu = !1;
                    k.update()
                })
            }
            ...
            function f(a) {
                a = b(a);
                0 < b(j).find(".navSubMenu").length ? (g(a).hide(), a.removeClass("highlightWithSubmenu"), a.find(".navLink").removeClass("highlightLinkWithSubmenu"), b.as24.menu.isHighlightElement(a) && b.as24.menu.highlightElement(a)) : b.as24.menu.isHighlightElement(a) || b.as24.menu.unhighlightElement(a)
            }
            ...
            function i() {
                g(j).show();
                b.as24.menu.callbacks && b.as24.menu.callbacks.submenuOpened &&
                0 < b.as24.menu.callbacks.submenuOpened.length && b.each(b.as24.menu.callbacks.submenuOpened, function (a, b) {
                    b(j)
                })
            }

            var h, j = b(this), k = {
                mouseOverMenu: !1, mouseOverSubMenu: !1, update: function () {
                    if (k.mouseOverMenu || k.mouseOverSubMenu) {
                        i();
                        var a = j.width(), c = g(j);
                        c.width() < a && c.width(a);
                        c = j.offset();
                        a = g(j);
                        c = a.hasClass("floatRight") ? c.left + j.outerWidth() - a.outerWidth() - 10 : c.left - 12;
                        a.css("left", c);
                        0 < b(j).find(".navSubMenu").length ? (b.as24.menu.unhighlightElement(j), j.addClass("highlightWithSubmenu"), j.find(".navLink").addClass("highlightLinkWithSubmenu")) :
                            b.as24.menu.highlightElement(j)
                    } else f(j)
                }
            };
            b.as24.menu.settings.isTouch ? a() : c()
        })
    };
    b.fn.as24login = function () {
        as24.ui.getCookie("User") ? (b(this).attr("href") && (b.as24.menu.replaceLoginWithLogout(this), b.as24.menu.hideDealerSubMenu(), b("#myas-register").remove()), b.as24.menu.insertLogoutSubmenu(), b("#loginLink").remove(), b("#logOut").as24menu()) : b("[id^=myas-loggedinonly-]").remove()
    };
    b.fn.as24dealerWelcomeBox = function () {
        var c = b.as24.menu.settings.dealerWelcomeText, e = a("User"), c = c.replace(/#NAME#/,
            function () {
                var a = e.FirstName;
                void 0 === a && (a = "");
                var b = e.LastName;
                void 0 === b && (b = "");
                if ("" !== a || "" !== b)return decodeURIComponent(a) + " " + decodeURIComponent(b);
                a = e.Name;
                return void 0 !== a ? decodeURIComponent(a) : "-"
            }()), c = c.replace(/#SELLID#/, function () {
            var a = e.SellId;
            return void 0 === a ? "" : a
        }()), c = c.replace(/#LASTLOGIN#/, function () {
            var a = e.LastLogin;
            return void 0 === a ? "-" : a
        }());
        this.html(c)
...
(function (b) {
    b.widget("as24.pictureGallery", {
        options: {
            thumb_width: 64,
            thumb_per_page: 9,
            callbacks: {afterImageVisible: null, beforeImageVisible: null},
            showTitleRow: !1,
            title: null
        }, _create: function () {
            this.gallery = this.element;
            this.wrapper = this.element.find(".pictureGalleryWrapper");
            this.preview = this.element.find(".pictureGalleryImage img");
            this.previewPrev = this.element.find(".pictureGalleryPrev");
            this.previewNext = this.element.find(".pictureGalleryNext");
            this.previewNaviPrev = this.element.find(".pictureGalleryNaviPrev");
            this.previewNaviNext = this.element.find(".pictureGalleryNaviNext");
            this.dataApi = {preview: "ui-gallery-preview", counter: "ui-gallery-preview-counter"};
            this._initWidget()
            ...
            this.thumbnails = {};
            this.thumbnails.items = this.element.find(".pictureGalleryThumbsList li");
            this.thumbnails.wrapper = {
                el: this.element.find(".pictureGalleryThumbs"),
                width: this.element.find(".pictureGalleryThumbs").width()
            };
            this.thumbnails.list = {
                el: this.element.find(".pictureGalleryThumbsList"),
                width: this.thumbnails.items.length * this.options.thumb_width
            };
            var a = Math.ceil(this.thumbnails.items.length / this.options.thumb_per_page);
            this.thumbnails.pages = {
                current: 0,
                count: 1 < a ? Math.ceil((a + this.thumbnails.items.length) / this.options.thumb_per_page) : a,
                lastThumb: this.options.thumb_per_page - 1
            };
            this.thumbnails.list.el.css({width: this.thumbnails.list.width + "px"});
            if (0 < this.thumbnails.items.length)this.thumbnails.items[0].className =
                "selected"
        }, _getImages: function () {
            var a = this, c = 1;
            a.thumbnails.list.el.find("img").each(function (d) {
                var e = b(this);
                a.images[d] = {thumbnail: e.prop("src"), preview: e.data(a.dataApi.preview), counter: d, page: c - 1};
                e.data(a.dataApi.counter, d);
                d === c * a.options.thumb_per_page - c && c++
            })
        }, _registerEvents: function () {
            var a = this;
            a._unregisterEvents();
            a.previewPrev.on("click.PictureGallery", function () {
                a._showPrev()
            });
            a.previewNext.on("click.PictureGallery", function () {
                a._showNext()
            });
            a.previewNaviPrev.on("click.PictureGallery",
                function () {
                    a._pageThumbnails(-1)
                });
            a.previewNaviNext.on("click.PictureGallery", function () {
                a._pageThumbnails(1)
            });
            a.thumbnails.items.on("click.PictureGallery", function () {
                a._showPreview(b(this).find("img").data(a.dataApi.counter))
            })
        }, _unregisterEvents: function () {
            this.previewPrev.off("click.PictureGallery");
            this.previewNext.off("click.PictureGallery");
            this.previewNaviPrev.off("click.PictureGallery");
            this.previewNaviNext.off("click.PictureGallery");
            this.thumbnails.items.off("click.PictureGallery")
        }, _showPrev: function () {
            var a =
                this.currentImageCounter;
            0 === a ? this._showPreview(this.images.length - 1) : this._showPreview(a - 1)
        }, _showNext: function () {
            var a = this.currentImageCounter;
            a === this.images.length - 1 ? this._showPreview(0) : this._showPreview(a + 1)
        }, _pageThumbnails: function (a) {
            a = this.thumbnails.pages.current + a;
            -1 < a && a < this.thumbnails.pages.count && this._animateThumbnailsTo(this._showPage(a))
        }, _jumpToThumbnail: function (a) {
            this.thumbnails.pages.current = this.images[a].page;
            var b = this._showPage(this.thumbnails.pages.current);
            a === this.thumbnails.pages.lastThumb ?
                this._pageThumbnails(1) : this._animateThumbnailsTo(b)
        }, _showPage: function (a) {
            var b = a * this.options.thumb_per_page - a;
            this.thumbnails.pages.current = a;
            this._setLastThumb(b);
            return b
        }, _setLastThumb: function (a) {
            this.thumbnails.pages.lastThumb = a + (this.options.thumb_per_page - 1)
        }, _animateThumbnailsTo: function (a) {
            a *= this.options.thumb_width;
            this.thumbnails.wrapper.el.animate({scrollLeft: (0 > a ? 0 : a) + "px"})
        }, _showPreview: function (a) {
            var b = this.images[a];
            "function" === typeof this.options.callbacks.beforeImageVisible &&
            this.options.callbacks.beforeImageVisible();
            this._showThumbnail(a);
            this.preview.prop("src", b.preview);
            this.currentImageCounter = b.counter;
            "function" === typeof this.options.callbacks.afterImageVisible && this.options.callbacks.afterImageVisible()
        }, _showThumbnail: function (a) {
            this.thumbnails.list.el.find("li.selected").removeClass("selected");
            this.thumbnails.list.el.find("li")[a].className = "selected";
            this._jumpToThumbnail(a)
        }, _setOption: function (a, b) {
            var d = this.element.find("[data-ui-gallery-title]");
            switch (a) {
                case "showTitleRow":
                    b ?
                        d.addClass("pictureGalleryTitle").show() : d.removeClass("pictureGalleryTitle").hide();
                    break;
                case "title":
                    0 < b.length && !d.hasClass("pictureGalleryTitle") && d.addClass("pictureGalleryTitle");
                    d.find(".fontHeadline").html(b);
                    break;
                case "link":
                    d.find("[data-ui-gallery-link]").prop("href", b);
                    break;
                case "linkText":
                    0 < b.length && !d.hasClass("pictureGalleryTitle") && d.addClass("pictureGalleryTitle");
                    d.find("[data-ui-gallery-link]").html(b);
                    break;
                case "images":
                    d = "";
                    if (b) {
                        for (var e = 0, f = b.length; e < f; e++)d += "<li><img src='" +
                            b[e].Thumbnail + "' data-ui-gallery-preview='" + b[e].PreviewImage + "'></li>";
                        this.preview.prop("src", b[0].PreviewImage)
                    } else this.preview.prop("src", "");
                    this.thumbnails.list.el.html(d);
                    this._initWidget()
            }
        }, widget: function () {
            return this
            ...
            this.element.data("as24PictureGallery", null).unbind(this.eventNamespace).removeData(this.widgetName).removeData(this.widgetFullName).removeData(b.camelCase(this.widgetFullName));
            this.bindings.unbind(this.eventNamespace)
        }
    })
})(jQuery);
(function (b) {
    b.widget("as24.characterCounter", {
        options: {limit: 300}, _create: function () {
            var a = this, c = b(document).find("[data-ui-character-counter]"), d = b(document).find("[data-ui-character-counter-label]");
            c && d && (c.on("keyup focus", function () {
                a._setCount(c, d)
            }), a._setCount(c, d))
        }, _setCount: function (a, b) {
            var d = a.val().length, e = a.attr("maxlength") || this.options.limit;
            if (d > e)a.value = a.value.substr(0, e), d = e;
            b.html(e - d)
        }
    })
})(jQuery);
$(function () {
    $(".inputPrefilled").one("change keyup", function () {
        $(this).removeClass("inputPrefilled")
    })
});

jQuery.parseQuery = function (c, e) {
    var f = "string" === typeof c ? c : window.location.search, d = {
        f: function (b) {
            return unescape(b).replace(/\+/g, " ")
        }
    }, d = jQuery.extend({}, d, "object" === typeof c && "undefined" === typeof e ? c : e), b = {};
    jQuery.each(f.match(/^\??(.*)$/)[1].split("&"), function (c, a) {
        a = a.split("=");
        a[1] = d.f(a[1]);
        b[a[0]] = b[a[0]] ? b[a[0]]instanceof Array ? (b[a[0]].push(a[1]), b[a[0]]) : [b[a[0]], a[1]] : a[1]
    });
    return b
};
/**
 * Created by mercatilorenzo on 15/10/15.
 */
var as24 = as24 || {};
as24.namespace = function (a) {
    var a = a.split("."), b = as24, c, d;
    "as24" === a[0] && (a = a.slice(1));
    for (d = 0; d < a.length; d++)c = a[d], "undefined" === typeof b[c] && (b[c] = {}), b = b[c];
    return b
};
var namespace = function (a, b, c) {
    var e;
    var a = a.split(b || "."), c = c || window, d;
    for (b = 0, d = a.length; b < d; b++)e = c[a[b]] = c[a[b]] || {}, c = e;
    return c
};

(function (f) {
    var j = f.attr;
    f.attr = function (b, c, a, d) {
        var e = this, g = !b.nodeType;
        void 0 === a ? e = g ? b[c] : j(b, c, a, d) : g ? (d = b[c], b[c] = a, f(b).trigger({
            type: c + "_change",
            attribute: c,
            newValue: a,
            oldValue: d
        }), f(b).trigger({type: "change", attribute: c, newValue: a, oldValue: d})) : j(b, c, a, d);
        return e
    };
    getBindingType = function (b) {
        b = f(b);
        if (0 < b.length)switch (b = b[0], b.nodeName) {
            case "INPUT":
                switch (b.type) {
                    case "hidden":
                    case "password":
    ...
    bindToView = function (b, c, a) {
        a();
        f(b).bind(c + "_change", a);
        return b
    };
    bindToProperty = function (b, c, a, d, e) {
        return bindToView(b, c, function () {
            var g = f(b).attr(c);
            void 0 !== e && (g = e(g));
            var h = "function" === typeof a ? a(g) : f(a);
            switch (d) {
                case void 0:
                case "val":
                    h.val(g);
    ...
    bindToRadio = function (b, c, a, d) {
        return bindToView(b, c, function () {
            var e = f(b).attr(c);
            void 0 !==
            d && (e = d(e));
            f(a).attr("checked", !1);
            f(a).filter("[value='" + e + "']").attr("checked", !0)
        })
    };
    bindToMoreVals = function (b, c, a, d) {
        void 0 === d && (d = function (b) {
            f(a).val(b)
        });
        return bindToView(b, c, function () {
            var a = f(b).attr(c).split(",");
            d(a)
        })
    };
    bindToCheckBox = function (b, c, a, d) {
        return bindToMoreVals(b, c, a, function (b) {
            f.each(b, function (b, c) {
                void 0 !== d && (c = d(c));
                f(a).filter("[value='" + c + "']").attr("checked", !0)
            })
        })
    };
    bindToMultiSelect = function (b, c, a, d) {
        return bindToMoreVals(b, c, a, function (b) {
            if (void 0 !== d)for (i =
                                      0; i < b.length; i++)b[i] = d(b[i]);
            f(a).val(b)
        })
    };
    bindFromView = function (b, c, a, d) {
        c = "function" === typeof c ? c(value) : f(c);
        a();
        d || (d = "change");
        c.bind(d, a);
        return b
    };
    bindFromProperty = function (b, c, a, d, e, g, h) {
        void 0 === d && (d = a);
        return bindFromView(b, a, function () {
            var a = "function" === typeof d ? d() : f(d);
            switch (e) {
                case void 0:
                case "val":
                    a = a.val();
    ...
    bindFromRadio = function (b, c, a, d, e) {
        return bindFromProperty(b, c, a, function () {
                return f(a).filter(":checked")
            },
            "val", d, e)
    };
    bindFromButton = function (b, c, a, d, e) {
        a = "function" === typeof a ? a() : f(a);
        e || (e = "click");
        a.bind(e, function () {
            var a = "function" === typeof d ? d(this.value) : this.value;
            f(b).attr(c, a)
        });
        return b
    };
    bindFromCheckBox = function (b, c, a, d, e) {
        return bindFromView(b, a, function () {
            var e = [];
            f.each(f(a).filter(":checked"), function (a, b) {
                e[a] = b.value;
                void 0 !== d && (e[a] = d(e[a]))
            });
            f(b).attr(c, e.join(","))
    ...
    bindFromMultiSelect = function (b, c, a, d, e) {
        return bindFromView(b, a, function () {
            var e = [];
            null != f(a).val() && f.each(f(a).val(),
                function (a, b) {
                    e[a] = b;
                    void 0 !== d && (e[a] = d(e[a]))
                });
    ...
    f.fn.extend({
        getBindingType: getBindingType, dataBind: function (b) {
            var c = b.modelAttribute, a = b.selector, d = b.translateTo, e = b.translateFrom, f = b.domProperty, h = b.initialDataInDom, b = b.eventToBind;
            switch (getBindingType(a)) {
                case "radio":
                    h ? (bindFromRadio(this, c, a, e, b), bindToRadio(this, c, a, d)) : (bindToRadio(this, c, a, d), bindFromRadio(this, c, a, e, b));
                    break;
                case "checkbox":
                    h ? (bindFromCheckBox(this, c, a, e, b), bindToCheckBox(this, c, a, d)) : (bindToCheckBox(this,
                        c, a, d), bindFromCheckBox(this, c, a, e, b));
                    break;
                case "multiselect":
                    h ? (bindFromMultiSelect(this, c, a, e, b), bindToMultiSelect(this, c, a, d)) : (bindToMultiSelect(this, c, a, d), bindFromMultiSelect(this, c, a, e, b));
                    break;
                case "button":
                    bindFromButton(this, c, a, e, b);
                    break;
                case "text":
                case "dropdown":
                    f || (f = "val");
                default:
                    f || (f = "text"), h ? (bindFromProperty(this, c, a, a, f, e, b), bindToProperty(this, c, a, f, d)) : (bindToProperty(this, c, a, f, d), bindFromProperty(this, c, a, a, f, e, b))
            }
            return this
        }
    })
...
(function (a) {
    a.fn.getmake = function (b) {
        b = a.extend({articleType: "C"}, b);
        return this.each(function () {
            obj = a(this);
            a.each(b.navMakeModelData.root.c, function (a, c) {
                var e = c.toString();
                obj.append('<option value="' + e.substring(1) + '">' + b.navMakeModelData[e].t + "</option>")
            })
        })
    };
    a.fn.getmodel = function (b) {
        b = a.extend({articleType: "C"}, b);
        return this.each(function () {
            obj = a(this);
            var d = "";
            a.each(b.navMakeModelData["m" + b.selectedValue].c, function () {
                var c = this.toString(), e = "l" == c.substring(0, 1);
                d += '<option value="' +
                    (e ? "-" : "") + c.substring(1) + '">' + b.navMakeModelData[c].t + "</option>";
                e && a.each(b.navMakeModelData[c].c, function () {
                    var a = this.toString();
                    d += '<option value="' + a.substring(1) + '">\u00a0\u00a0\u00a0\u00a0' + b.navMakeModelData[a].t + "</option>"
                })
            });
            obj.append(d)
        })
...
define("as24/search/settings", function () {
    return {
        totalCounterToggleEnabled: !1,
        totalCounterEnabled: !1,
        colorCountersEnabled: !1,
        equipmentCountersEnabled: !1,
        locationCounterEnabled: !0,
        allCountries: "B,D,F,I,L,NL,A,E,BG,CH,CZ,HR,LT,LV,PL,RO,RUS,S,SLO,TR,UA,SK,GB",
        otherCountries: "BG,CH,CZ,HR,LT,LV,PL,RO,S,SLO,TR,UA,RUS,SK,GB",
        defaultCountry: "D",
        defaultRadius: "200",
        defaultPriceFrom: "1000",
        articleTypeId: "C",
        offer: "0"
    }
});

define("as24/search/citysearch", ["as24/search/settings", "as24/search/searchParams", "as24/search/zipRadius"], function (e, g, h) {
    var o = "", k = 0, l, f = null, m = null, d = {
        serviceUrl: "/CitySearch.ashx", defaultCulture: "", shouldChangeCYParamOnValidInput: !1, init: function () {
            function p(a, b) {
                var c;
                if (void 0 == b || null == b)b = "";
                switch (b.toString().toUpperCase()) {
                    case "A":
                    case "B":
                    case "L":
                        c = /^[0-9]{4}$/;
            ...
            function s(a, b) {
                var c = d.serviceUrl + "?" + encodeURI(o + "&country=" + e.defaultCountry + "&culture=" + d.defaultCulture + "&term=" + a), i = new XDomainRequest;
                i.open("get", c);
                i.onload = function () {
                    n($.parseJSON(this.responseText), a, b)
                };
                i.send()
            }
            ...
            function n(a, b, c) {
                if (0 < a.length) {
                    f = a[0];
                    var i = {tloc: b, lat: f.lat, lon: f.lon, zip: f.value, zipc: e.defaultCountry};
                    if (d.shouldChangeCYParamOnValidInput)i.cy = "";
                    $("#zipcode").val(b);
                    h.enable();
                    g.update(i)
                } else j(b);
            ...
            function q(a) {
                h.enable();
                a = {tloc: "", lat: "", lon: "", zip: a, zipc: e.defaultCountry};
                if (d.shouldChangeCYParamOnValidInput)a.cy = "";
                g.update(a)
            }

            function r(a, b) {
                var c = {tloc: b, lat: a.lat, lon: a.lon, zip: a.value, zipc: e.defaultCountry};
                if (d.shouldChangeCYParamOnValidInput)c.cy = "";
                $("#zipcode").val(a.value);
                h.enable();
                g.update(c)
            }
            ...
            function j(a) {
                f = null;
                a = {tloc: a, lat: "", lon: "", zip: ""};
                if (d.shouldChangeCYParamOnValidInput)a.cy = e.defaultCountry;
                h.disable();
                g.update(a)
            }

            h.init();
            $("#zipcode").keydown(function (a) {
                13 ==
                a.which && a.preventDefault()
            });
            "" !== g.zip && ($("#zipcode").val(g.zip), h.enable());
            if (-1 < navigator.userAgent.toLowerCase().indexOf("firefox"))window.onunload = window.onunload || function () {
                };
            l = function (a, b) {
                $.ajax({
                    url: d.serviceUrl,
                    data: encodeURI(o + "&country=" + e.defaultCountry + "&culture=" + d.defaultCulture + "&term=" + a),
                    dataType: "json",
                    autocompleteRequest: ++k,
                    success: function (c) {
                        this.autocompleteRequest === k && n(c, a, b)
                    },
                    error: function () {
                        this.autocompleteRequest === k && n([], a, b)
                    }
                })
            };
            -1 < navigator.userAgent.toLowerCase().indexOf("msie") &&
            window.XDomainRequest && (l = s);
            $("body").hasClass("ie7") && $("html")[0].getAttribute && ($.attrHooks["aria-autocomplete"] = {
                set: function (a, b, c) {
                    a.setAttribute(c, b)
                }
            });
            $("#zipcode").autocomplete({
                delay: 50, source: function (a, b) {
                    var c = $.trim(a.term);
                    isNaN(c.slice(0, 4)) ? l(c, function (a) {
                        b(a);
                        $(".ui-autocomplete").css("top", "0px");
                        $(".ui-autocomplete").css("left", "0px");
                        $(".ui-menu-item a").each(function () {
                            var a = $(this).html(), b = c.length, d = a.substr(0, b), a = a.substr(b);
                            $(this).html(d + ('<span class="boldtext">' +
                                a + "</span>"))
                        })
                    }) : p(c, e.defaultCountry) ? q(c) : j("")
                }, appendTo: "#mapSuggestionBox", change: function (a, b) {
                    var c = $.trim(a.target.value);
                    null === b.item && null === m && ("" !== $("#zipcode").val() ? null !== f ? r(f, c) : p(c, e.defaultCountry) ? q(c) : j("") : j(""));
                    m = null
                }, select: function (a, b) {
                    m = b.item;
                    r(b.item, b.item.label)
                }, open: function () {
                    var a = $("#zipcode").position().top + $("#zipcode").height() + 8, b = $("#zipcode").position().left;
                    $("#mapSuggestionBox").css("top", a + "px").css("left", b + "px");
                    $(".ui-autocomplete").css({width: ""});
                    $(".ui-autocomplete").removeClass("ui-menu ui-widget ui-widget-content ui-corner-all");
                    $(".ui-autocomplete").css("display", "block");
                    $("#mapSuggestionBox").css("display", "block")
                }, close: function () {
                    $(".ui-autocomplete").css("display", "none");
                    $("#mapSuggestionBox").css("display", "none");
                    "" === $("#zipcode").val() && j("")
                }
            });
...
define("as24/search/initHome2", "as24/search/searchParams,as24/search/makeModel,as24/search/searchButton.home2,as24/search/extendedSearchLink,as24/search/citysearch,as24/search/settings,as24/search/refinementCounter".split(","), function (a, g, h, i, f, b, j) {
    function k() {
        var a = !1;
        "undefined" !== typeof remove1000Filter && remove1000Filter && (a = "true" === remove1000Filter.toLocaleLowerCase());
        return a
    }
    ...
    return {
        init: function () {
            a.init();
            g.init();
            h.init($("#counterTextSingular").text(), $("#counterTextPlural").text());
            i.init();
            f.init();
            var e = k();
            f.shouldChangeCYParamOnValidInput = !0;
            $(a).dataBind({modelAttribute: "fuel", selector: "#fuel"});
            $(a).dataBind({modelAttribute: "eq", selector: "input[name=equip]"});
            $(a).dataBind({modelAttribute: "fregfrom", selector: "#yearfrom"});
            $(a).dataBind({modelAttribute: "powerto", selector: "#powerto"});
            $(a).dataBind({modelAttribute: "fregto", selector: "#yearto"});
            $(a).dataBind({modelAttribute: "priceto", selector: "#priceto"});
            $(a).dataBind({modelAttribute: "kmto", selector: "#mileageto"});
            $(a).dataBind({
                modelAttribute: "zipr",
                selector: "#zipradius"
            });
            a.isDefault = function () {
                return ("0" === this.mmvmk0 || "" === this.mmvmk0) && ("0" === this.mmvmd0 || "" === this.mmvmd0) && ("0" === this.priceto || "" === this.priceto) && ("0" === this.fregfrom || "" === this.fregfrom) && ("0" === this.kmto || "" === this.kmto) && "0" === this.fuel && "" === this.eq && (this.zipr === b.defaultRadius || "" === this.zipr) && "" === this.zip
            };
            a.pricefrom = e ? "" : b.defaultPriceFrom;
            $(a).change(function (c) {
                if ("priceto" === c.attribute) {
                    var c = parseInt(c.newValue, 10), d = e ? "" : parseInt(b.defaultPriceFrom, 10);
                    $(a).attr("pricefrom",
                        c <= d || 0 === c ? "0" : e ? "" : b.defaultPriceFrom)
                }
            });
            j.init();
            var d = function (a) {
                return "undefined" !== typeof $.parseQuery()[a]
            };
            if (!d("cy"))a.cy = b.defaultCountry;
            if (!/zipr=\d+/.test(window.location.hash))a.zipr = b.defaultRadius;
            if (!d("offer"))a.offer = b.offer;
            if ("RUS" === b.defaultCountry && !d("pic"))a.pic = "True";
            $(".quickSearchTab").click(function () {
...
function Watchlist(m, k, f) {
    function j() {
        var a = g(), c = n(), b = r();
        if (!c || a.visitorId !== c || a.customerId && a.customerId !== b)a = i(), h(a);
        c && (b && !a.customerId ? v(a.watchlistId, a.commands, b) : !b && a.customerId ? h(i()) : void 0 === a.sequence ? w(a.watchlistId) : s(a.watchlistId, a.commands, a.sequence))
    }

    function v(a, c, b) {
        0 < c.length ? m("POST", f + "C+" + b + "/commands", {commands: c}, function () {
            t(a, b)
        }) : t(a, b)
    }
    ...
    function t(a, c) {
        var b = g();
        if (a === b.watchlistId)b = i(), b.customerId = c, b.watchlistId = "C+" + c, h(b);
        j()
    }

    function s(a, c, b) {
        m("POST",
            f + a + "/sync?sequence=" + b, {commands: c}, function (b) {
                var e = g();
                if (a === e.watchlistId) {
                    var f = b.events.length - (b.sequence - e.sequence);
                    0 > f ? (h(i()), j()) : (f = b.events.slice(f), u(e.commands, c), u(e.commands, f), e.classifieds = o(e.classifieds, f), e.sequence = b.sequence, h(e), k())
                }
            })
    }

    function u(a, c) {
        for (var b = 0; b < c.length; b += 1)for (var d = 0; d < a.length; d += 1)if (a[d].type === c[b].type && a[d].timestamp === c[b].timestamp && ("M" === a[d].type ? a[d].customerId === c[b].customerId : a[d].classifiedGuid === c[b].classifiedGuid)) {
            a.splice(d,
                1);
            break
        }
    ...
    function w(a) {
        m("GET", f + a + "/classifieds", null, function (c) {
            var b = g();
            if (!(void 0 !== b.sequence || b.watchlistId != a)) {
                for (var d = c.classifieds, e = 0; e < d.length; e += 1)b.classifieds[d[e].classifiedGuid] = !0;
                b.sequence = c.sequence;
                h(b);
                0 < b.commands.length && s(b.watchlistId, b.commands, b.sequence);
                k()
            }
        })
    }
    ...
    function n() {
        var a = document.cookie.match(/as24Visitor=([^;]+)/i);
        return a ? a[1] : null
    }

    function r() {
        var a = document.cookie.match(/User=[^;]*CustomerID=(\d+)/i);
        return a ? a[1] : null
    }
    ...
    function q(a, c) {
        var b = g();
        99 < b.commands.length || (b.commands.push({type: a, timestamp: new Date, classifiedGuid: c}), h(b), k(), j())
    }

    function g() {
        try {
            var a = JSON.parse(window.localStorage.watchlist);
            return 1 === a.version && a.classifieds && a.commands && a.visitorId ? a : i()
        } catch (c) {
            return i()
        }
    }
    ...
    function i() {
        var a = n();
        return {watchlistId: "V+" + a, visitorId: a, classifieds: {}, commands: [], version: 1}
    }

    function h(a) {
        if (!a)throw"no state given";
        p = o(a.classifieds, a.commands);
        window.localStorage.watchlist = JSON.stringify(a)
    }
    ...
    function o(a,
        ...
        for (var b = 0; b < c.length; b += 1) {
            ...
            switch (d.type) {
                case "A":
                    a[d.classifiedGuid] = !0;
                    break;
                case "R":
                    delete a[d.classifiedGuid];
                    break;
                case "M":
                    a = {}
            }
    ...
    f = f || "//watchlist.a.autoscout24.com/watchlist/";
    this.add = function (a) {
        l(a) || q("A", a)
    };
    ...
    var p = function () {
        var a = g();
        return o(a.classifieds, a.commands)
    }();
    j();
    setTimeout(k, 0)
}
if ("undefined" !== typeof module)module.exports = Watchlist;

define("as24/watchlist/watchlist-home-integration", ["as24/common/String.shortening"], function (j) {
    function g(b, c, a, d) {
        function f(a, b, c, d) {
            ...
            setTimeout(function () {
                e.send("undefined" != typeof c ? JSON.stringify(c) : void 0)
            }, 0)
        }

        function g(a, c, b, d) {
            $.ajax(c, {
                method: a, crossDomain: !0, cache: !0, contentType: "text/plain", data: b ? JSON.stringify(b) : void 0,
                processData: !1, success: d
            })
        }

        doAjax = 0 < $(".ie8").length + $(".ie9").length ? f : g;
        doAjax(b, c, a, d)
    }

    function k() {
        $("#serviceBoxContainer .cms-box").addClass("hidden");
        $("#serviceBoxHome").addClass("hidden");
        $("#serviceBoxParkdeck").addClass("hidden");
        $("#serviceBoxParkdeckTeaser").addClass("hidden");
        $("#serviceBoxSeparator").addClass("hidden");
        $("#serviceBoxLastSearch").addClass("hidden");
        var b = f.count(), c = 0 < $("#lastSearchContainer").length;
        if (0 < b) {
            h();
            $("#parkdeckContentLink span.fontSilent").text(b);
            $("#serviceBoxParkdeck").removeClass("hidden");
            for (var b = f.getClassifieds().slice(0, 4), a = "", d = 0; d < b.length; d++)0 < a.length && (a += "&"), a = a + "guids=" + b[d];
            g("GET", "/ServiceBox?" + a, null, l);
            $(document).trigger("ServiceBoxIsShown", ["Box-Parkdeck"]);
            c ? i() : ($("#serviceBoxLastSearch").removeClass("hidden"), $(document).trigger("ServiceBoxIsShown", ["BodyType"]))
        } else c ? (h(), $("#serviceBoxParkdeckTeaser").removeClass("hidden"), $(document).trigger("ServiceBoxIsShown", ["Teaser-Parkdeck"]), i()) : $("#serviceBoxContainer .cms-box").removeClass("hidden");
        as24.homeServiceBox.track()
    }

    function h() {
        $("#serviceBoxHome").removeClass("hidden");
        $("#serviceBoxSeparator").removeClass("hidden")
    }

    function i() {
        $("#serviceBoxLastSearch").removeClass("hidden");
        j.truncateElementTextToLines("#lastSearchDescription", 2, 18, ",");
        $(document).trigger("ServiceBoxIsShown", ["LastSearch"])
    }

    function l(b) {
        for (var c = 0; 4 > c; c++) {
            var a = "#parkdeckThumbnail" + c;
            c < b.length ? ($(a + " img").attr("src", b[c]), $(a).removeClass("hidden")) : $(a).addClass("hidden")
        }
    }
...
define("as24/topClassifieds/topClassifieds", function () {
    var b, a = 0, d = function (e) {
        var d = $("#topClassifieds .topClassified").length, f;
        a += e;
        0 > a && (a += b.length);
        a >= b.length && (a -= b.length);
        e = a;
        $.as24.toggles.TopClassifiedBoxPreventDuplicates && d >= b.length && $("#topClassifieds .carouselLeft, #topClassifieds .carouselRight").hide();
        for (var c = 0; c < d; c++)if ($.as24.toggles.TopClassifiedBoxPreventDuplicates && c >= b.length)$("#tcLink" + c).parent().css("visibility", "hidden"); else {
            try {
                if (f = b[e]) {
                    $("#tcLink" + c).css("backgroundImage",
                        "url(" + f.ImageUrl + ")");
                    $("#tcLink" + c).attr("href", f.Link);
                    var g = $("#tcModel" + c);
                    g.text(f.MakeModelText);
                    g.attr("href", f.Link);
                    $("#tcPrice" + c).text(f.Price);
                    e++
                }
            } catch (h) {
            }
    ...
    return {
        init: function (a) {
            b = a;
            $("#topClassifieds .carouselLeft").click(function () {
                d(-1)
            });
            $("#topClassifieds .carouselRight").click(function () {
                d(1)
            });
            d(0)
        }, circleTopClassifieds: d
    }
});
...
(function () {
    function g(a, d) {
        ...
        c.setAttribute("src", h(a, d));
        c.setAttribute("width", b.imageWidth);
        c.setAttribute("height", b.imageHeight);
    ...
    function e(a) {
        "interactive" === document.readyState && history.pushState && -1 < navigator.userAgent.toLowerCase().indexOf("webkit") && history.pushState(location.href);
        window.location = a
    }

    function h(a, d) {
        var c = b.trackingUrl + "?source=" +
            a + "&url=" + d + "&timestamp=" + (new Date).getTime() + "&visitor=", f = $.cookie("as24Visitor");
        return c + ("undefined" === typeof f || null === f ? "" : f)
    }

    var b = namespace("$.as24.common.tracker.settings");
    $.extend(b, {
        trackingUrl: b.trackingUrl || "tracking.autoscout24.com",
        timeoutInMs: b.timeoutInMs || 500,
        imageWidth: b.imageWidth || 2,
        imageHeight: b.imageHeight || 2
    });
    var j = namespace("$.as24.common.tracker");
    $.extend(j, {
        blindClickTracking: function (a, b) {
        ...
        }, getTrackingUrl: h, clickTracking: function (a, b, c) {
            $(document).on("click", a, function () {
                try {
                    var a = $(this).attr(c);
...
jQuery.cookie = function (e, c, a) {
    a = jQuery.extend({}, {
        encode: encodeURIComponent, decode: function (a) {
            var b;
            try {
    ...
    if ("undefined" != typeof c) {
        ...
        var d = a.path ? "; path=" + a.path : "", f = a.domain ? "; domain=" +
        a.domain : "", g = a.secure ? "; secure" : "";
        document.cookie = [e, "=", a.encode(c), b, d, f, g].join("")
    } else {
        c = null;
        if (document.cookie && "" != document.cookie) {
            b = document.cookie.split(";");
            for (d = 0; d < b.length; d++)if (f = jQuery.trim(b[d]), f.substring(0, e.length + 1) == e + "=") {
                c = a.decode(f.substring(e.length + 1));
                break
            }
        }
        return c
...
(function () {
    namespace("$.as24").isToggleEnabled = function (a) {
        return "undefined" == typeof $.as24.toggles[a] ? !1 : !0
    }
})();
...
$(document).ready(function () {
    ...
    function f() {
        var a = 0, b = 0;
        document.body.scrollHeight > window.innerHeight && (a = l());
        window.innerWidth > $("body").width() && (b = -((window.innerWidth -
        a - $("body").width()) / 2));
        window.setTimeout(function () {
            $(".headerNavigation .navSubMenu").css("marginLeft", b + "px")
        }, 200);
        $("#inPageAd,#inPageAd_NEU").css("marginLeft", b + "px");
        g && (window.setTimeout(function () {
            $(".bubble .bubbleContent").parent().css("marginLeft", b + "px")
        }, 200), g = !1)
    }

    function h() {
        10 < d.clientHeight && (d.className += " paddingTopBlockXL", window.clearInterval(i))
    }

    function j() {
        10 < e.offset().top && ($(".brandDayBody").css("paddingLeft", "2px"), e.addClass("paddingTopBlockS"), window.clearInterval(k))
    }

    var g = !0, d = document.getElementById("88110136"), e = $(".grid"), i, k;
    d && (i = window.setInterval(h, 150), h());
    0 < e.length && (k = window.setInterval(j, 150), j());
...
define("as24/search/zipRadius", ["as24/search/settings", "as24/search/searchParams"], function (c, a) {
    function b() {
        $("#zipradius,.__radius").addClass("disabled").attr("disabled", "disabled");
        $("div.location-radius div.points").addClass("points-disabled");
        "" === a.zip && $(a).attr("zipr", c.defaultRadius)
    }
    ...
    return {
        init: function () {
            ...
            $("#zipradius,.__radius").removeClass("disabled").removeAttr("disabled");
            $("div.location-radius div.points").removeClass("points-disabled")
        }, disable: b, isEnabled: function () {
            return "disabled" !==
                $("#zipradius,.__radius").attr("disabled")
        }
    }
});

define("as24/search/searchParams", ["as24/search/settings"], function (e) {
    function f(a, d) {
        var b = !1;
        if (a && navMakeModelData["m" + a]) {
            var c = 0 > d ? "l" + d.substring(1) : "d" + d;
            $.each(navMakeModelData["m" + a].c, function () {
                var a = this.toString();
                0 == a.indexOf("l") ? a == c ? b = !0 : $.each(navMakeModelData[a].c, function () {
                    this.toString() == c && (b = !0)
                }) : a == c && (b = !0)
            })
        }
    ...
    function k(a) {
        function d(a, d, b) {
            var g = [];
            $.each([a, d, b], function (a, c) {
                void 0 !== c && null != c && "" != c && "0" != c && g.push(c)
            });
            return g
        }
        ...
        (function (a) {
            a.doorto =
                "0";
            if (a.doorfrom) {
                var d = parseInt(a.doorfrom);
                0 < d && (a.doorto = d + 1)
            }
            isNaN(a.doorto) && (a.doorto = "0")
        })(a);
        (function (a) {
            var b = d(a.mmvmk0, a.mmvmk1, a.mmvmk2);
            a.mmvco = b.length;
            a.make = 0 < b.length ? b.join(",") : "";
            b = d(a.mmvmd0, a.mmvmd1, a.mmvmd2);
            a.model = 0 < b.length ? b.join(",") : ""
        })(a);
        a = function (a) {
            var b = {};
            $.each(a, function (a, c) {
                null !== c && "" !== c && "0" !== c && "undefined" !== c && !a.match("^jQuery") && "function" !== typeof c && (b[a] = c)
            });
            return b
        }(a);
        (function (a) {
            if (!a.lat && !a.lon && !a.zip || !a.zip)a.zipr = "";
            var b = e.allCountries.split(",").length;
            if (a.cy && a.cy.split(",").length >= b || -1 < $.inArray(a.cy, e.otherCountries.split(",")))a.cy = "";
            a.allcy = ""
        })(a);
        a.zip && 0 < a.zip.length && (a.cy = "");
        (function (a) {
            if (a.eq) {
                var b = a.eq.split(",");
                if (0 < b.length && "D" !== a.fuel) {
                    var d = [];
                    $.each(b, function (a, b) {
                        "53" != b && d.push(b)
                    });
        ...
        $.each(a, function (a, d) {
            "" !== d && b.push(a + "=" + encodeURIComponent(d))
        });
        return b.join("&")
    }
    ...
    b.init = function () {
        var a = 0 < window.location.hash.length ? window.location.hash : window.location.search;
        if (!a)this.cy = e.defaultCountry, this.zipr = e.defaultRadius, this.offer = e.offer;
        if (e.offer && "N" == e.offer)this.offer = e.offer;
        this.atype = e.articleTypeId;
        $.extend(this, h(a))
    };
    b.buildUrl = function () {
        var a = k(this), b = window.location.toString(), e = b.indexOf("#");
        0 < e && (b = b.substring(0, e));
        b = b + "#" + a;
        void 0 !== window.history.pushState ? window.history.replaceState(null, null, b) : window.location.replace(b);
        return a
    };
    var j =
        function (a) {
            var d = {};
            $.each($.parseQuery(a, {f: i}), function (a, c) {
                if (c) {
                    var e = $.isArray(c) ? c : null !== c && "" !== c ? c.split(",") : [], f = [];
                    null != a && "" != a && void 0 != b[a] && $.each(e, function (a, b) {
                        "undefined" !== b && "null" != b && "" != b && f.push(b)
                    });
                    0 < f.length && (d[a] = f.sort().join(","))
                }
            });
            return d
        }, i = function (a) {
        ...
        if (!(1 >= a.length))return a = j(a), !a.mmvmk0 && a.make && (a.mmvmk0 = a.make), !a.mmvmd0 && a.model &&
        f(a.mmvmk0, a.model) && (a.mmvmd0 = a.model), !a.mmvmd1 && a.model && f(a.mmvmk1, a.model) && (a.mmvmd1 = a.model), !a.mmvmd2 && a.model && f(a.mmvmk2, a.model) && (a.mmvmd2 = a.model), a.fregfrom && isNaN(a.fregfrom) && (a.fregfrom = (new Date(a.fregfrom)).getFullYear()), a.fregto && isNaN(a.fregto) && (a.fregto = (new Date(a.fregto)).getFullYear()), a
    };
    b.parseQueryToStringOfDecodedValues = j;
    b.parseQuery = h;
    b.defaultDecoder = i;
    b.update = function (a) {
        a = b.updateWithoutChange(a);
        $(a).change()
    };
    b.updateWithoutChange = function (a) {
        var d = b;
        return d =
            $.extend(d, a)
    };
    b.isDefault = function () {
        return !1
    };
    b.isSingleCountrySelected = function () {
        return 0 < b.cy.length ? -1 === b.cy.indexOf(",") : !1
    };
    return b
});

define("as24/search/refinementCounter", ["as24/search/settings", "as24/search/searchParams"], function (f, e) {
    function g(a) {
        if ((!a || !("zip" === a.attribute || "tloc" === a.attribute)) && !h) {
            h = !0;
            var a = setTimeout, d;
            d = (new Date).getTime();
            d = Math.max(m, j + n - d);
    ...
    function k() {
        ...
        h = !1;
        j = (new Date).getTime();
        e.isDefault() ? $(c).attr("total", null) : f.totalCounterEnabled && (a = e.buildUrl(), f.colorCountersEnabled && c.callCounter("bodycolor", a), f.equipmentCountersEnabled && c.callCounter("equipment", a), f.locationCounterEnabled &&
        c.callCounter("location", a))
    }
    ...
    function l(a) {
        function d() {
            ...
            if (e.cy && a.country) {
                var c = e.cy.split(",");
                0 < c.length && $.each(c, function () {
                    var b = this.toLowerCase();
                    $.each(a.country, function () {
                        this.i == b && this.v && (d += parseInt(this.v))
                    })
                })
            }
            return i(d, b)
        ...
        var b = "string" == typeof f.thousendSeparator ? f.thousendSeparator : " ";
        return !e.cy || 23 == e.cy.split(",").length || -1 < $.inArray(e.cy, f.otherCountries.split(",")) ? i(a.tc, b) || "0" : d()
    }
    ...
    function i(a, d) {
        ...
        try {
            for (x =
                     0; x < a.length; x++) {
                var b = b + a.substring(x, x + 1), c;
                var e = a.length - x - 1;
                c = 0 == e ? !1 : 3 * Math.floor(e / 3) == e ? !0 : !1;
                c && (b += d)
            }
            return b
        } catch (f) {
    ...
    var c = {
        init: function () {
            $(e).bind("change", g);
            0 < window.location.hash.length && g(null)
        },
        update: g,
        callRemoteService: k,
        callCounter: function (a, d) {
            $.ajax({
                url: "/GN/CountV1.ashx",
                data: d + "&tab=" + a,
                type: "GET",
                ...
                traditional: !0,
                success: function (b) {
                    b && (c[a + "Total"] = b.tc || "0", "location" == a ? ($(c).attr(a, b.country || {}), $(c).attr("total",
                        l(b))) : $(c).attr(a, b[a] || {}))
                }
            })
        },
        getFormatedTotalCount: l,
        formatNumber: i,
        total: null,
        bodycolor: {},
        equipment: {},
...
define("as24/search/extendedSearchLink", ["as24/search/searchParams"], function (c) {
    return {
        init: function () {
            var b = $(".extendedLink"), a = b.attr("href"), d = -1 < a.indexOf("?") ? a.split("?")[0] : a;
            b.bind("click", function () {
                var a = c.buildUrl();
                window.location.href = d + (a ? "?" + a : a) + "&intcidm=HP-Searchmask-Extendedsearch";
                return !1
            })
        }
    }
...
define("as24/search/searchButton.home2", ["as24/search/refinementCounter", "as24/search/searchParams", "as24/search/settings"], function (f, d, g) {
    return {
        init: function (i, j) {
            var b = $("#blockSearchButton .buttonBobM"), h = b.val().split(" ")[0], k = b.val().split(" ")[1], l = document.getElementById("fireplaceSearchMask") ? "topMiddle" : "leftBottom", e = $("#bubbleNoResults").bubble({
                type: "note",
                target: "#blockSearchButton .buttonBobM",
                pointer: l,
                contentClass: "gridWidth3"
            });
            e.bubble("close");
            $(f).bind("total_change", function (a) {
                var a =
                    a.newValue, c;
                null === a ? (a = h, c = k) : c = "1" === a ? i : j;
                0 >= parseInt(a, 10) ? (b.addClass("disabled"), e.bubble("open")) : (b.removeClass("disabled"), e.bubble("close"));
                b.val(a + " " + c)
            });
            b.bind("click", function () {
                if (!("0" === (f.total || h) || b.hasClass("disabled"))) {
                    d.cy = d.zip ? "" : g.defaultCountry;
                    var a = d.priceFrom, a = a ? a : "";
                    if ("undefined" !== typeof remove1000Filter) {
                        var c = !1;
                        remove1000Filter && (c = "true" === remove1000Filter.toLocaleLowerCase());
                        c && (a = "")
                    }
                    d.priceFrom = a;
                    a = d.buildUrl();
                    location.href = g.targetPage + (a ? "?" + a + "&fromhome=1&intcidm=HP-Searchmask-Button" :
                            "?fromhome=1&intcidm=HP-Searchmask-Button")
                }
            })
        }
    }
...
define("as24/search/makeModel", ["as24/search/searchParams"], function (h) {
    function i() {
        var b = {"de-DE": [9, 13, 29, 47, 54, 74]}[$.as24.locale.culture];
        if (b) {
            var a = document.getElementById("make1");
            if (a) {
                for (var e = a.options[0], c = [], d = 0; d < b.length; d++) {
                    var f = $("#make1 option[value=" + b[d] + "]")[0];
                    if (f) {
                ...
                if (0 < c.length) {
                    ...
                    for (d = document.createElement("optgroup"); 0 < a.children.length;)f = a.removeChild(a.firstChild),
                        d.appendChild(f);
                    d.label = "----------";
                    a.appendChild(e);
                    for (e = 0; e < c.length; e++)a.appendChild(c[e]);
                    a.appendChild(d);
                    $("#make1").val(b)
                }
            }
    ...
    function j() {
        var b = $(h);
        b.dataBind({modelAttribute: "mmvmk0", selector: "#make1"});
        $("#make1").change();
        b.dataBind({modelAttribute: "mmvmd0", selector: "#model1"});
        b.dataBind({modelAttribute: "mmvmk1", selector: "#make2"});
        $("#make2").change();
        b.dataBind({modelAttribute: "mmvmd1", selector: "#model2"});
        b.dataBind({modelAttribute: "mmvmk2", selector: "#make3"});
        $("#make3").change();
        b.dataBind({modelAttribute: "mmvmd2", selector: "#model3"});
        b.dataBind({modelAttribute: "version", selector: "#version"})
    }

    $.fn.initMakeModel = function (b) {
        var a = this;
        $(this).getmake({navMakeModelData: navMakeModelData});
        this.change(function () {
            var e = $(this).val(), c = $($(b)[a.index($(this))]);
            c.find("option:gt(0)").remove();
            0 < e && c.getmodel({navMakeModelData: navMakeModelData, selectedValue: e});
            c.val("0")
        })
    };
    return {
        init: function () {
            var b = $("#make1,#make2,#make3");
            b.initMakeModel("#model1,#model2,#model3");
            window.FireplaceIsEnabled &&
            i();
            b.bind("change", function () {
                var a = parseInt(this.id.substring(this.id.length - 1)), b = this.selectedIndex, c = $("#model" + a);
                0 < b ? (c.removeClass("disabled"), c.removeAttr("disabled"), $("#modelLabel" + a).find("label").removeClass("label-disabled"), $("#make1Container").removeClass("points-disabled").addClass("points")) : (c.addClass("disabled"), c.attr("disabled", "disabled"), $("#modelLabel" + a).find("label").addClass("label-disabled"), $("#make1Container").removeClass("points").addClass("points-disabled"));
                if (0 <
                    b)$("div.model:eq(" + (a - 1) + ")").removeClass("disabled"), 3 > a && ($("#make" + (a + 1)).removeAttr("disabled").removeClass("disabled"), $("div.make:eq(" + a + ")").removeClass("disabled")); else for (a = 1; 3 > a; a++) {
                    var b = $("#make" + a), d = $("#make" + (a + 1));
                    0 < d.length && 0 < b.length && 0 == b[0].selectedIndex && 0 == d[0].selectedIndex && (d.attr("disabled", "disabled").addClass("disabled"), $("div.make:eq(" + a + ")").addClass("disabled"), $("div.model:eq(" + a + ")").addClass("disabled"))
                }
                c.val("0");
                c.change();
                c.hide();
            ...
            $("#make2,#make3,#model1,#model2,#model3").attr("disabled",
                "disabled").addClass("disabled");
            $("div.make:gt(0),div.model").addClass("disabled");
            j()
        }
    }
});

define("as24/common/String.shortening", function () {
    return {
        truncateElementTextToLines: function (b, c, d, e) {
            var f = d * c;
            $(b).each(function () {
                for (var a = $(this).text(); $(this).height() > f;) {
                    var b = a.lastIndexOf(e), a = a.substring(0, b) + "...";
                    $(this).text(a)
                }
            })
        }
